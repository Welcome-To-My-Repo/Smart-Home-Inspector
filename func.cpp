...
void remove_expression (GtkWidget *entrybox)
{
	std::cout << "Remove Expression Called!" << std::endl;
	std::cout << gtk_entry_buffer_get_text (gtk_entry_get_buffer (GTK_ENTRY (entrybox))) << std::endl;
	//std::string expression = "";
	//expression.append (gtk_entry_buffer_get_text (GTK_ENTRY_BUFFER (gtk_entry_get_buffer (GTK_ENTRY (entrybox)))));
